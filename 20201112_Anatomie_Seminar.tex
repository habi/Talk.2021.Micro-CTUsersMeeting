...
\begin{frame}
	...
	\mode<handout>{%
		\includegraphics[height=0.618\textheight]{./movies/ct-scanner/ct-canner0001}%
		\source{youtu.be/2CWpZKuy-NE}{}%
		}
...
\begin{frame}[label=currentsadfasd]
	\frametitle{Why \uct?}
	\begin{columns}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.6\linewidth}
			...
			\includegraphics<2|handout:2>[width=\imwidth]{./images/2214}%
			\only<2|handout:2>{\source{bruker.com/skyscan2214}{}}
...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center){%
			\animategraphics[autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/full/image}{0000}{0179}%
			};%
	\end{tikzpicture}%
\end{frame}
	...
	\begin{columns}
		\begin{column}{0.49\linewidth}
			\begin{itemize}
				...
				\item<6> \emph{Reproducible} analysis~\cite{Haberthur2020a}, you can click a button to redo it yourself
			\end{itemize}
		\end{column}
		\begin{column}{0.49\linewidth}
			\only<1>{%
				\centering
				\includegraphics[height=.7\textheight]{./images/bucketofteeth}%
				}%
			\only<2>{%
				\lstinputlisting[linerange={2-5,17-17,19-23,29-31,34-34,38-40,51-51,58-59}]{./logfiles/Tooth045.log}%
				}%
			\only<3>{%
				In total:
				\begin{itemize}
					\item Sample changer
					\item 13 days of \uct scanning
...
\begin{frame}[label=current]
	...
	\centering
	\includegraphics<1>[height=0.7\textheight]{./images/{{ScanOverviews.104}}}%
	\includegraphics<2>[height=0.7\textheight]{./images/{{ScanOverviews.24}}}%
\end{frame}	
...
\begin{frame}[label=current]
	...
	\centering
	\only<1>{%
		\includegraphics[height=0.7\textheight]{/media/habi/Fast_SSD/Talks/20201112_Anatomie_Seminar/images/tooth045/{{Tooth045.ExtractedSlices}}}%
		}
	\only<2>{%
		\includegraphics[width=\linewidth]{/media/habi/Fast_SSD/Talks/20201112_Anatomie_Seminar/images/tooth045/{{Tooth045.Briseno}}}%
		}
\end{frame}
...
\begin{frame}[label=current]
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center){%
			\animategraphics[loop,autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/pulpa-slices/image}{0000}{0179}%
			};%
	\end{tikzpicture}%
\end{frame}
...
\begin{frame}[label=current]
	...
	\centering
	\only<1>{%
		\animategraphics[palindrome,autoplay,height=0.7\textheight,every=\everyframe]{24}{./movies/tooth045/edt-axial/Tooth045_EDT_Axial_}{100}{199}%
		}%
	\only<2>{%
		\animategraphics[palindrome,autoplay,height=0.7\textheight,every=\everyframe]{24}{./movies/tooth045/edt-coronal/Tooth045_EDT_Coronal_}{123}{213}%
		}		
\end{frame}
...
\begin{frame}[label=currentasdfasdf]
	...
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}
			\centering
			\includegraphics<1->[height=.7\textheight]{./images/team}
		\end{column}
	\end{columns}
	\only<4|handout:0>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[loop,autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/full/image}{0000}{0179}%
				};%
		\end{tikzpicture}%
	}%
\end{frame}
