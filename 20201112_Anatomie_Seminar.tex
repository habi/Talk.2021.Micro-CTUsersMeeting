...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center){%
			\animategraphics[autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/full-slices/image0}{000}{466}%
			};%
	\end{tikzpicture}%
\end{frame}
...
\begin{frame}[label=current]
	...
	\centering
	\only<1>{%
		\includegraphics[height=0.7\textheight]{./images/tooth045/{{Tooth045.ExtractedSlices}}}%
		}
	\only<2>{%
...
\begin{frame}[label=current]
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center){%
			...
			\only<2>{\animategraphics[loop,autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/pulpa-slices/image0}{000}{476}}%
			};%
	\end{tikzpicture}%
\end{frame}
...
\begin{frame}[label=currentasdfasdf]
	...
	\only<4>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[loop,autoplay,width=\paperwidth,every=\everyframe]{24}{./movies/tooth045/pulpa-slices/image0}{000}{476}%
				};%
		\end{tikzpicture}%
	}%
\end{frame}
