% Compile with:
% latexmk -pdf -pvc -interaction=nonstopmode\documentclass[aspectratio=169,draft]{beamer}
	...
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}
			...
			\only<4>{%
				...
				\sourcecite{Briseño-Marroquin2015}{Fig.~2}%
				}%
			\only<5>{%
				\centering%
...
\begin{frame}
	...
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center) [shift={(0,-25pt)}]{%
			...
			\only<2>{\includegraphics[height=\imheight]{./images/briseno}\sourcecite{Briseño-Marroquin2015}{Fig.~2}}%
...
\begin{frame}[label=current, shrink=20]
...
\begin{frame}[label=current]
	...
	\renewcommand{\imheight}{\paperheight}%
	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center) {%
		\includegraphics[height=\imheight]{./images/rcs/Tooth0278}%
		\includegraphics[height=\imheight]{./images/rcs/Tooth0352}%
		\includegraphics[height=\imheight]{./images/rcs/Tooth0411}%
...
\begin{frame}[label=current]
	...
	\begin{table}[]
		...
		\toprule
		\# of Foramina & \multicolumn{2}{c}{1} & \multicolumn{2}{c}{2} & \multicolumn{2}{c}{3} & \multicolumn{2}{l}{4} \\
          & \#  & \%   & \#  & \%    & \# & \%    & \# & \%    \\
\midrule
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Preparation of data for further publications 
	\end{itemize}
\end{frame}
