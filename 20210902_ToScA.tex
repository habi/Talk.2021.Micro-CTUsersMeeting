...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}
			\centering
			\includegraphics<1>[height=\imheight]{./images/kopf_dh}
			\includegraphics<2>[height=\imheight]{./images/kopf_rh}
			\includegraphics<3>[height=\imheight]{./images/wolf_thomas_Web}
		\end{column}
	\end{columns}
	\only<4>{%
		\begin{tikzpicture}[remember picture,overlay]%
	...
	\begin{columns}
		...
		\begin{column}{0.4\linewidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item \href{https://github.com/habi/Talk.2021.ToScA}{Complete source available at git.io/J0tjG}
				\end{itemize}
				\item Did you spot an error?
				\begin{itemize}
					\item \href{https://github.com/habi/Talk.2021.ToScA/issues}{File an issue: git.io/J0tj7}
					\item \href{mailto:haberthuer@ana.unibe.ch?subject=Error\%20in\%20the\%20ToScA\%20presentation\&body=https://xkcd.com/386/}{Send me an email: haberthuer@ana.unibe.ch}
				\end{itemize}
			\end{itemize}
		\end{column}
	\end{columns}
