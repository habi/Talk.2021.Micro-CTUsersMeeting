...
\begin{frame}[label=current]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Post-Doc II: \uct-group, at the Institute of Anatomy of the University of Bern. With Ruslan Hlushchuk, Oleksiy-Zakhar Khoma and Tim Hoessly
		\end{itemize}
	\end{itemize}
\end{frame}

\renewcommand{\imheight}{0.5\paperheight}% set global image height
\begin{frame}[label=current]
	\frametitle{Grüessech!}		
	\begin{columns}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.49\linewidth}
			\only<1>{%
				\centering
				\renewcommand{\imwidth}{0.618\linewidth}% set global image width
