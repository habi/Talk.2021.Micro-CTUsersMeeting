	...
	\begin{columns}
		\begin{column}{0.618\linewidth}	
			\begin{itemize}
				...
				\begin{itemize}
					\item Angiogenesis in the heart, musculature~\cite{Nording2021} and bones
					\item Vasculature in the (mouse) brain~\cite{Hlushchuk2020}, (human) nerve scaffolds~\cite{Wuthrich2020} and (human) skin flaps~\cite{Zubler2021}
					\item Tumor vasculature
				\end{itemize}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.5\linewidth}
			\only<1>{%
				\centering
				\renewcommand{\imwidth}{0.8\linewidth}% set global image width
			...
			\only<4>{%
				\includegraphics[width=\linewidth]{./images/briseno}%
				\sourcecite{Briseno-Marroquin2015}{Fig.~2}%
				}%
			\only<5>{%
				\includegraphics[width=\linewidth]{./images/foramen}%
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}	
		\begin{column}{0.618\linewidth}
			\includegraphics<1>[width=\linewidth]{./images/tooth045/{{Tooth045.Cropper.Original}}}
			\includegraphics<2>[width=\linewidth]{./images/tooth045/{{Tooth045.Cropper.Cropped}}}			
		\end{column}	
	\end{columns}		
\end{frame}
